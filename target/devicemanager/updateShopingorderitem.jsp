        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="changedevice"  action="updateShopingorderitem.action" class="form-horizontal form-horizontal m-t">

                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">订单项编号</label>

                            <div class="col-sm-10">
                                <input type="text" name="shopingorderitemId" id="shopingorderitemId" class="form-control" style="width:280px">
                            </div>
                        </div>
