        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="adddevice"  action="addShopingorderitem.action" class="form-horizontal form-horizontal m-t">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="shopingOrderID" id="shopingOrderID" class="form-control" style="width:280px">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="buyNum" id="buyNum" class="form-control" style="width:280px">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button id="btnsub" class="btn btn-primary" type="submit" onclick="javascript:alert('订单项添加成功')">添加</button>
                            </div>
                        </div>
                    </form>
                </div>
