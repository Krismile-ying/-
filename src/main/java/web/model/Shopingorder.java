...
public class Shopingorder {
    ...
    @Id
    @Column(name = "ShopingOrderID", nullable = false)
    ...
    @Basic
    @Column(name = "ReceiveAddress", nullable = true, length = 255)
    ...
    @Basic
    @Column(name = "MoneyAmount", nullable = true, length = 255)
    ...
    @OneToMany(mappedBy = "shopingorderByShopingOrderId")
