        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="adddevice"  action="addShopingcart.action" class="form-horizontal form-horizontal m-t">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="addDeviceID" id="addDeviceID" class="form-control" style="width:280px">
                            </div>
                        </div>

                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">购物数量</label>
                            <div class="col-sm-10">
                                <input type="text" name="addBuyNum" id="addBuyNum" class="form-control" style="width:280px">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="addUserID" id="addUserID" class="form-control" style="width:280px">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button id="btnsub" class="btn btn-primary" type="submit" onclick="javascript:alert('购物项添加成功')">添加</button>
                            </div>
                        </div>
                    </form>
                </div>
