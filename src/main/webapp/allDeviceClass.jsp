            ...
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-1"
                                          aria-expanded="true">设备分类列表</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#datatable1').DataTable({
            ...
            ajax : "findAllDeviceClass.action",
            aoColumns : [ {
                "data" : "DeviceClassID"
            }, {
                ...
                "render": function (
                    ...
                    var html = "<div style='margin-top:5px;' ><a href='allDevice.jsp?deviceClassId=" + data + " ' class='btn btn-success btn-xs' style='padding-top:5px'><i class='fa fa-close'></i>详情</a></div>"
                    html += "<div style='margin-top:5px' ><a href='deleteDeviceClass?deleteDeviceClassId="+data+" ' class='btn btn-success btn-xs' style='padding-top:5px'><i class='fa fa-close'></i>删除</a></div>";
                    return html;
                }
            }],
        });
