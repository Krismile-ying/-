        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="adddevice"  action="addDeviceClass.action" class="form-horizontal form-horizontal m-t">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="deviceClassName" id="deviceClassName" class="form-control" style="width:280px">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button id="btnsub" class="btn btn-primary" type="submit" onclick="javascript:alert('设备分类添加成功')">添加</button>
                            </div>
                        </div>
                    </form>
                </div>
