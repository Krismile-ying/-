        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="changedevice"  action="deleteDevice.action" class="form-horizontal form-horizontal m-t">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="deviceId" id="deviceId" value="" class="form-control" style="width:280px">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                <button id="btnsub" class="btn btn-primary"
                                        onClick="Delete()" type="button">确认</button>
