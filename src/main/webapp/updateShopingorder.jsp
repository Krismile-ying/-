        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="changedevice"  action="updateShopingorder.action" class="form-horizontal form-horizontal m-t">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">金额总数</label>
                            <div class="col-sm-10">
