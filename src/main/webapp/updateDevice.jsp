        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" >
                    <form method="post" name="changedevice"  action="updateDeviceById.action" class="form-horizontal form-horizontal m-t">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="deviceId" id="deviceId" class="form-control" style="width:280px">
                            </div>
                        </div>

                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">新设备名称</label>
                            <div class="col-sm-10">
                        ...
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">新设备价格</label>
                            <div class="col-sm-10">
